
{
    ...
    'description': 'This module allows you to assign location to order'
                   'lines in the Point of Sale (POS) Switch Between Warehouses in POS 16 Development',
    ...
    'assets': {
        'point_of_sale.assets': [
            ...
            'switch_warehouse_location_pos/static/src/js/pos_popup.js',
            'switch_warehouse_location_pos/static/src/xml/pos_screen_templates.xml',
            'switch_warehouse_location_pos/static/src/xml/pos_popup_templates.xml',
